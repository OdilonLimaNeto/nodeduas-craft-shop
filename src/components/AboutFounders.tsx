...
const founders = [
  {
    ...
    description:
      "Apaixonada por crochê desde a adolescência, Ana traz criatividade e inovação para cada design. Com mais de 8 anos de experiência, ela é responsável pela criação dos padrões únicos que fazem do Nó de Duas uma marca especial.",
  ...
  },
  {
    ...
    description:
      "Com habilidades excepcionais no crochê e um olhar apurado para detalhes, Thayná garante que cada peça mantenha a qualidade artesanal que nossos clientes esperam. Sua dedicação é o coração da nossa produção.",
    specialties: [
      "Artesanato Fino",
...
export const AboutFounders = () => {
  return (
    <section id="sobre" className="scroll-mt-24 py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-craft-muted max-w-2xl mx-auto">
            Duas amigas unidas pela paixão do crochê, criando peças únicas com
        ...
        <div className="text-center mt-12">
          <div className="craft-card p-6 inline-block">
            <p className="text-craft-muted italic">
              &quot;Juntas, transformamos fios em histórias e criamos peças que
              levam amor para cada lar.&quot;
            </p>
            <p className="text-craft-coral font-semibold mt-2">
              - Ana & Thayná
            </p>
          </div>
        </div>
